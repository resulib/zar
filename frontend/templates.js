/* ==================================================================
   ...
   132 şablon · 11 kateqoriya · 10 dizayn · 5 palitra
...
window.CATEGORIES = [
  ...
  { id: 'family',    name: 'Ailə / Uşaqlar',        icon: '⌂', blurb: 'Valideyn-övlad diplomatiyası, dərs saatı, ekran vaxtı və ev işləri.' },
  { id: 'relatives', name: 'Qohumlar / Qaynana',    icon: '❉', blurb: 'Gəlin-qaynana protokolu, toy məsləhətləri və bayram ziyarətləri.' },
  { id: 'student',   name: 'Tələbələr',             icon: '✎', blurb: 'İmtahan, konspekt borcu, yataqxana və dərsə gecikmə üzrə.' },
  { id: 'neighbors', name: 'Qonşular / Həyət',      icon: '⌗', blurb: 'Səs-küy, park yeri, pilləkən növbəsi və uşaq meydançası.' },
  { id: 'holiday',   name: 'Bayram & Toy',          icon: '✵', blurb: 'Novruz, toy masası, hədiyyə öhdəlikləri və qonaq qəbulu.' },
  { id: 'travel',    name: 'Səyahət / Yol',         icon: '✈', blurb: 'Çamadan, naviqasiya səlahiyyəti, sürücülük növbəsi və otel seçimi.' },
  { id: 'pets',      name: 'Ev heyvanları',         icon: '✿', blurb: 'Pişik-it səlahiyyətnamələri, yemləmə növbəsi və divan hüququ.' },
  { id: 'gaming',    name: 'Oyunçular',             icon: '▶', blurb: 'Rank, komanda seçimi, ekran vaxtı və klaviatura sülhü.' }
];
...
{
  id: 'always-right', cat: 'couples', layout: 'qerar', palette: 'burgundy',
...
{
  id: 'late-reply', cat: 'couples', layout: 'vesiqe', palette: 'steel',
...
{
  id: 'family-visit', cat: 'couples', layout: 'arayis', palette: 'ink',
...
{
  id: 'sock-treaty', cat: 'couples', layout: 'muqavile', palette: 'forest',
...
{
  id: 'gps-authority', cat: 'couples', layout: 'teleqram', palette: 'gold',
...
/* ==================== DOSTLAR ==================== */
{
  id: 'friend-traitor', cat: 'friends', layout: 'qerar', palette: 'burgundy',
...
{
  id: 'late-pass', cat: 'friends', layout: 'vesiqe', palette: 'burgundy',
...
{
  id: 'group-chat', cat: 'friends', layout: 'teleqram', palette: 'ink',
...
{
  id: 'taxi-split', cat: 'friends', layout: 'arayis', palette: 'forest',
...
{
  id: 'dietary-oath', cat: 'friends', layout: 'muqavile', palette: 'forest',
...
{
  id: 'tomorrow-promise', cat: 'work', layout: 'teleqram', palette: 'burgundy',
...
{
  id: 'deadline-extension', cat: 'work', layout: 'qerar', palette: 'steel',
...
{
  id: 'cc-authority', cat: 'work', layout: 'muqavile', palette: 'ink',
...
{
  id: 'lunch-king', cat: 'work', layout: 'vesiqe', palette: 'burgundy',
...
{
  id: 'excuse-registry', cat: 'work', layout: 'arayis', palette: 'ink',
...
{
  id: 'ac-authority', cat: 'work', layout: 'blank', palette: 'burgundy',
...
/* ---------------- AİLƏ / UŞAQLAR ---------------- */
{
  id: 'homework-truce', cat: 'family', layout: 'notarial', palette: 'gold',
...
{
  id: 'screen-time-license', cat: 'family', layout: 'lisenziya', palette: 'ink',
...
{
  id: 'allowance-contract', cat: 'family', layout: 'muqavile', palette: 'steel',
...
{
  id: 'bedtime-decree', cat: 'family', layout: 'blank', palette: 'burgundy',
...
{
  id: 'room-cleaning-act', cat: 'family', layout: 'arayis', palette: 'forest',
...
{
  id: 'best-child-diploma', cat: 'family', layout: 'diplom', palette: 'burgundy',
...
{
  id: 'dinner-veto', cat: 'family', layout: 'sertifikat', palette: 'steel',
...
{
  id: 'parent-verdict', cat: 'family', layout: 'qerar', palette: 'ink',
...
{
  id: 'sibling-peace', cat: 'family', layout: 'muqavile', palette: 'forest',
...
{
  id: 'grade-telegram', cat: 'family', layout: 'teleqram', palette: 'gold',
...
{
  id: 'junior-id', cat: 'family', layout: 'vesiqe', palette: 'steel',
...
{
  id: 'chore-authority', cat: 'family', layout: 'notarial', palette: 'burgundy',
...
/* ---------------- QOHUMLAR / QAYNANA ---------------- */
{
  id: 'mother-in-law-protocol', cat: 'relatives', layout: 'blank', palette: 'burgundy',
...
{
  id: 'recipe-secret-act', cat: 'relatives', layout: 'notarial', palette: 'gold',
...
{
  id: 'wedding-advice-license', cat: 'relatives', layout: 'lisenziya', palette: 'burgundy',
...
{
  id: 'guest-visit-permit', cat: 'relatives', layout: 'arayis', palette: 'steel',
...
{
  id: 'family-council-decision', cat: 'relatives', layout: 'qerar', palette: 'ink',
...
{
  id: 'best-son-in-law', cat: 'relatives', layout: 'diplom', palette: 'gold',
...
{
  id: 'plov-authority', cat: 'relatives', layout: 'sertifikat', palette: 'forest',
...
{
  id: 'holiday-visit-contract', cat: 'relatives', layout: 'muqavile', palette: 'burgundy',
...
{
  id: 'relative-telegram', cat: 'relatives', layout: 'teleqram', palette: 'forest',
...
{
  id: 'bride-id', cat: 'relatives', layout: 'vesiqe', palette: 'burgundy',
...
{
  id: 'comparison-ban', cat: 'relatives', layout: 'blank', palette: 'ink',
...
{
  id: 'tea-ceremony-act', cat: 'relatives', layout: 'notarial', palette: 'steel',
...
{
  id: 'exam-luck-certificate', cat: 'student', layout: 'sertifikat', palette: 'gold',
...
{
  id: 'konspekt-loan', cat: 'student', layout: 'muqavile', palette: 'steel',
...
{
  id: 'dorm-charter', cat: 'student', layout: 'blank', palette: 'forest',
...
{
  id: 'late-arrival-license', cat: 'student', layout: 'lisenziya', palette: 'burgundy',
...
{
  id: 'attendance-arayis', cat: 'student', layout: 'arayis', palette: 'steel',
...
{
  id: 'deadline-decision', cat: 'student', layout: 'qerar', palette: 'ink',
...
{
  id: 'group-leader-diploma', cat: 'student', layout: 'diplom', palette: 'burgundy',
...
{
  id: 'coffee-night-act', cat: 'student', layout: 'notarial', palette: 'ink',
...
{
  id: 'exam-telegram', cat: 'student', layout: 'teleqram', palette: 'gold',
...
{
  id: 'student-id', cat: 'student', layout: 'vesiqe', palette: 'forest',
...
{
  id: 'presentation-authority', cat: 'student', layout: 'sertifikat', palette: 'forest',
...
{
  id: 'retake-amnesty', cat: 'student', layout: 'blank', palette: 'gold',
...
/* ---------------- QONŞULAR / HƏYƏT ---------------- */
{
  id: 'noise-curfew', cat: 'neighbors', layout: 'blank', palette: 'steel',
...
{
  id: 'parking-authority', cat: 'neighbors', layout: 'notarial', palette: 'gold',
...
{
  id: 'stairwell-duty', cat: 'neighbors', layout: 'arayis', palette: 'forest',
...
{
  id: 'drill-license', cat: 'neighbors', layout: 'lisenziya', palette: 'burgundy',
...
{
  id: 'yard-court-decision', cat: 'neighbors', layout: 'qerar', palette: 'ink',
...
{
  id: 'best-neighbor-diploma', cat: 'neighbors', layout: 'diplom', palette: 'gold',
...
{
  id: 'balcony-treaty', cat: 'neighbors', layout: 'muqavile', palette: 'steel',
...
{
  id: 'playground-rules', cat: 'neighbors', layout: 'sertifikat', palette: 'forest',
...
{
  id: 'neighbor-telegram', cat: 'neighbors', layout: 'teleqram', palette: 'burgundy',
...
{
  id: 'resident-id', cat: 'neighbors', layout: 'vesiqe', palette: 'ink',
...
{
  id: 'salt-borrow-act', cat: 'neighbors', layout: 'notarial', palette: 'burgundy',
...
{
  id: 'wifi-sharing-permit', cat: 'neighbors', layout: 'arayis', palette: 'steel',
...
/* ---------------- BAYRAM, TOY & AD GÜNÜ ---------------- */
{
  id: 'novruz-sweet-quota', cat: 'holiday', layout: 'blank', palette: 'gold',
...
{
  id: 'wedding-table-contract', cat: 'holiday', layout: 'muqavile', palette: 'burgundy',
...
{
  id: 'gift-obligation', cat: 'holiday', layout: 'notarial', palette: 'gold',
...
{
  id: 'birthday-decree', cat: 'holiday', layout: 'blank', palette: 'burgundy',
...
{
  id: 'dance-license', cat: 'holiday', layout: 'lisenziya', palette: 'gold',
...
{
  id: 'guest-list-arayis', cat: 'holiday', layout: 'arayis', palette: 'steel',
...
{
  id: 'toastmaster-diploma', cat: 'holiday', layout: 'diplom', palette: 'burgundy',
...
{
  id: 'holiday-court', cat: 'holiday', layout: 'qerar', palette: 'ink',
...
{
  id: 'congrats-telegram', cat: 'holiday', layout: 'teleqram', palette: 'gold',
...
{
  id: 'guest-id', cat: 'holiday', layout: 'vesiqe', palette: 'burgundy',
...
{
  id: 'photo-duty-certificate', cat: 'holiday', layout: 'sertifikat', palette: 'forest',
...
{
  id: 'leftovers-treaty', cat: 'holiday', layout: 'muqavile', palette: 'forest',
...
/* ---------------- SƏYAHƏT / YOL ---------------- */
{
  id: 'suitcase-quota', cat: 'travel', layout: 'blank', palette: 'steel',
...
{
  id: 'navigator-authority', cat: 'travel', layout: 'notarial', palette: 'steel',
...
{
  id: 'driving-shift-contract', cat: 'travel', layout: 'muqavile', palette: 'ink',
...
{
  id: 'playlist-license', cat: 'travel', layout: 'lisenziya', palette: 'gold',
...
{
  id: 'hotel-choice-arayis', cat: 'travel', layout: 'arayis', palette: 'forest',
...
{
  id: 'delay-decision', cat: 'travel', layout: 'qerar', palette: 'burgundy',
...
{
  id: 'best-traveler-diploma', cat: 'travel', layout: 'diplom', palette: 'gold',
...
{
  id: 'photo-stop-certificate', cat: 'travel', layout: 'sertifikat', palette: 'steel',
...
{
  id: 'arrival-telegram', cat: 'travel', layout: 'teleqram', palette: 'forest',
...
{
  id: 'traveler-id', cat: 'travel', layout: 'vesiqe', palette: 'steel',
...
{
  id: 'snack-authority', cat: 'travel', layout: 'notarial', palette: 'burgundy',
...
{
  id: 'window-seat-treaty', cat: 'travel', layout: 'muqavile', palette: 'gold',
...
/* ---------------- EV HEYVANLARI ---------------- */
{
  id: 'sofa-rights', cat: 'pets', layout: 'notarial', palette: 'gold',
...
{
  id: 'feeding-duty', cat: 'pets', layout: 'arayis', palette: 'forest',
...
{
  id: 'cat-license', cat: 'pets', layout: 'lisenziya', palette: 'ink',
...
{
  id: 'walk-contract', cat: 'pets', layout: 'muqavile', palette: 'forest',
...
{
  id: 'good-boy-diploma', cat: 'pets', layout: 'diplom', palette: 'gold',
...
{
  id: 'bark-decree', cat: 'pets', layout: 'blank', palette: 'steel',
...
{
  id: 'vet-visit-arayis', cat: 'pets', layout: 'arayis', palette: 'steel',
...
{
  id: 'pet-court', cat: 'pets', layout: 'qerar', palette: 'burgundy',
...
{
  id: 'pet-id', cat: 'pets', layout: 'vesiqe', palette: 'gold',
...
{
  id: 'treat-certificate', cat: 'pets', layout: 'sertifikat', palette: 'burgundy',
...
{
  id: 'lost-toy-telegram', cat: 'pets', layout: 'teleqram', palette: 'ink',
...
{
  id: 'bed-sharing-act', cat: 'pets', layout: 'notarial', palette: 'steel',
...
/* ---------------- OYUNÇULAR / GAMER ---------------- */
{
  id: 'rank-certificate', cat: 'gaming', layout: 'sertifikat', palette: 'ink',
...
{
  id: 'team-contract', cat: 'gaming', layout: 'muqavile', palette: 'steel',
...
{
  id: 'screen-time-decree', cat: 'gaming', layout: 'blank', palette: 'ink',
...
{
  id: 'keyboard-peace', cat: 'gaming', layout: 'notarial', palette: 'steel',
...
{
  id: 'mvp-diploma', cat: 'gaming', layout: 'diplom', palette: 'gold',
...
{
  id: 'lag-excuse-license', cat: 'gaming', layout: 'lisenziya', palette: 'forest',
...
{
  id: 'rage-quit-decision', cat: 'gaming', layout: 'qerar', palette: 'burgundy',
...
{
  id: 'loot-split-arayis', cat: 'gaming', layout: 'arayis', palette: 'gold',
...
{
  id: 'gg-telegram', cat: 'gaming', layout: 'teleqram', palette: 'ink',
...
{
  id: 'player-id', cat: 'gaming', layout: 'vesiqe', palette: 'ink',
...
{
  id: 'controller-authority', cat: 'gaming', layout: 'sertifikat', palette: 'burgundy',
...
{
  id: 'revenge-match-treaty', cat: 'gaming', layout: 'muqavile', palette: 'burgundy',
